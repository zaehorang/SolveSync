...
GitHub App은 필요한 Sync Repository에만 설치하세요. issue, screenshot, logs에 access token, refresh token, device code, cookie, session 값, private solution code를 포함하지 마세요.
