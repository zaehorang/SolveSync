...
결정: 특정 GitHub repository를 코드 기본값으로 고정하지 않는다. 현재 인증 방식은 ADR 0029를 따르며, 확장은 로그인 계정이 소유하고 GitHub App이 설치된 repository 목록을 보여주고 사용자가 Sync Repository와 Sync Branch를 선택한다.
