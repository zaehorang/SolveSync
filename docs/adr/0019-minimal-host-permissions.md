...
결정: v1 manifest는 `storage`, `https://leetcode.com/*`, `https://school.programmers.co.kr/*`, `https://github.com/*`, `https://api.github.com/*`, LeetCode/Programmers 문제 페이지 content script match로 제한한다.
